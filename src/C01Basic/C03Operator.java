...
////        후위증감연산자
//        int b = 5;
//        int c = b++; //실행문이 끝나고 b가 증가 = 전위증감연산자
//        int d = ++b; //실행문이 끝나기 전에 b가 증가 = 후위증감연산자
...
//        논리연산자 : &&, ||, !
        ...
        int num2 = 20;
        boolean result1;
//        num1이 5보다 큰지와 num1이 20보다 작은지 and조건을 통해 boolean값 세팅
        result1 =num1 > 5 && num1 < 20;
        System.out.println(result1);
//        num2이 10보다 작은 조건과 num2이 30보다 작은지 or조건으로 boolean값 세팅
//        해당 결과값에 부정의 ! 추가
